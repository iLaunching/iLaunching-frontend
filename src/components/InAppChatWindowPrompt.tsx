import InAppRichTextInput from '@/components/InAppRichTextInput';

interface InAppChatWindowPromptProps {
...
export default function InAppChatWindowPrompt({
