...
interface InAppRichTextInputProps {
...
export default function InAppRichTextInput({
  onSubmit,
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'in-app-rich-text-input-editor',
  ...
  return (
    <div className={`rich-text-input-container ${className}`}>
      <form onSubmit={handleSubmit}>
        <div className="in-app-rich-text-input-wrapper">
          {/* Editor Area */}
      ...
      <style>{`
        ...
        .in-app-rich-text-input-wrapper {
          ...
          overflow: visible;
          box-shadow: 0 2px 6px rgba(147, 51, 234, 0.25), 0 1px 4px rgba(37, 99, 235, 0.25);
        }
        ...
        .rich-text-plus-btn-dropdown {
          ...
          width: 28px !important; /* Increased */
          height: 28px !important; /* Increased */
