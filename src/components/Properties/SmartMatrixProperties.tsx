...
export const SmartMatrixProperties: React.FC<SmartMatrixPropertiesProps> = ({
    ...
    const [leftWidth, setLeftWidth] = useState(300); // Reduced initial width for smaller panel
    ...
    useEffect(() => {
        ...
        const updatePosition = () => {
            ...
            // Handle limits for resizing based on new width
            setLeftWidth(prev => {
                const newWidth = prev + e.movementX;
                return Math.max(150, Math.min(newWidth, 450)); // Clamp for smaller panel
            });
        };
...
return (
    <div
        ...
        style={{
            ...
            boxShadow: '0 4px 24px rgba(0, 0, 0, 0.04)', // Ultra subtle shadow
