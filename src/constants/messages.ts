...
export const INTRODUCTION_MESSAGES = [
  "{name}, welcome to iLaunching! Here's the thing about success: it's not one-size-fits-all. It's not static. It's not passive. It's personal. Your business is unique, your journey is yours alone, and where you are right now matters. That's why this entire platform is a blank canvas, ready to be shaped around you, your needs, and your goals. No templates. No forcing you into someone else's system. Just you, your vision, and a platform that adapts to where you actually are. Let's build something that fits you perfectly.",
  
  "Hey {name}! Welcome to iLaunching. Success isn't something you copy—it's something you create. And here's what makes this different: we don't believe in generic solutions. Every business is different. Every founder is at a different stage. You might be validating an idea, or ready to scale, or somewhere in between. That's why this platform is designed to meet you exactly where you are. It's a blank canvas that transforms based on your individual needs, not the other way around. Let's make this about you.",
  
  "{name}, welcome! You're about to experience something different. Most platforms force you into their way of doing things. We don't. Because success isn't passive—it's active. It's based on who you are, what you need, and where you are in your journey right now. No two businesses are the same. No two founders start from the same place. That's why iLaunching is built as a blank canvas, ready to be tailored specifically to you. Your needs shape the platform, not the other way around. Let's create your path forward.",
  
  "Welcome to iLaunching, {name}! Here's what you need to know: success is personal. It's not a blueprint you follow—it's something you build based on your unique situation, your goals, and where you are right now. That's the core of what we do here. This platform is a blank canvas. It doesn't force you into a rigid system. Instead, it adapts to you. Your individual needs, your specific journey, your actual circumstances. Because no business is the same, and no founder should be treated like they are. Let's build something uniquely yours.",
  
  "{name}, you're here! And here's why this matters: success isn't static. It's not something you achieve by following someone else's exact steps. It's active, personal, and deeply tied to your individual journey. Where you are right now, what you need right now—that's what matters. That's why iLaunching is different. This entire platform is a blank canvas, designed to be shaped around you. Your needs. Your goals. Your stage. We meet you where you are and tailor everything to fit. Let's make this work for you.",
  
  "Welcome, {name}! Let me tell you what makes iLaunching different. Success isn't passive—it's not about fitting into someone else's system. It's active, personal, and completely dependent on your unique situation. Every founder is different. Every business is at a different stage. That's why we built this as a blank canvas. The platform adapts to you, not the other way around. Your individual needs shape what you see, what you get, and how you move forward. No templates. No one-size-fits-all. Just you and a system that fits you perfectly. Let's go.",
  
  "{name}, welcome to iLaunching! Here's the reality: no two businesses are the same. No two founders are in the same position. Success is personal—it's based on your individuality, your specific needs, and exactly where you are in your journey. That's why we don't use templates here. This platform is a blank canvas, ready to be tailored specifically to you. You shape it. Your needs define it. Your journey determines what happens next. We meet you where you are and build around that. Let's create something that actually works for you.",
  
  "Hey {name}! Welcome to iLaunching. Here's what you're about to experience: a platform that doesn't treat you like everyone else. Because you're not. Success isn't static—it's not about following the same path as the person next to you. It's active, personal, and based entirely on your unique situation. Where are you right now? What do you actually need? That's what matters. And that's why this is a blank canvas. It transforms based on you. Your individual needs. Your specific goals. Your actual journey. Let's build something tailored to you.",
  
  "Welcome, {name}! You're in the right place. Here's why: success isn't passive. It's not about fitting yourself into a rigid system. It's about building something that fits you. Your business is unique. Your journey is yours alone. And where you are right now matters more than anything. That's why iLaunching is built as a blank canvas. The platform adapts to your individual needs, not the other way around. You define what this looks like. You shape what happens next. Let's make this about you and your success.",
  
  "{name}, welcome! Here's what makes this different: we believe success is personal. It's not static. It's not passive. It's actively based on who you are, what you need, and where you are in your journey. Every founder is different. Every business is at a unique stage. That's why we don't force you into templates or generic solutions. This platform is a blank canvas, designed to be shaped entirely around you. Your needs. Your goals. Your reality. We meet you where you are and tailor everything to fit. Let's build your path forward.",
  
  "Welcome to iLaunching, {name}! Here's the truth about success: it's not one-size-fits-all. It's personal, active, and completely tied to your individual journey. Where you are right now, what you need right now—that's what drives everything here. No two businesses are the same. No two founders should follow the same exact path. That's why this platform is a blank canvas. It's designed to adapt to you. Your specific needs shape what you see and what you get. We tailor everything to fit your reality. Let's create something uniquely yours.",
  
  "{name}, you're here! And I'm excited because you're about to experience something different. Success isn't passive—it's not about copying what someone else did. It's active, personal, and based on your unique situation. Every founder has different needs. Every business is at a different stage. That's why iLaunching is built as a blank canvas. The platform transforms based on you. Your individual needs. Your specific goals. Your actual journey. We don't force you into a system—we build the system around you. Let's make this yours.",
  
  "Hey {name}! Welcome to iLaunching. Here's what you need to know: success is deeply personal. It's not static. It's not passive. It's actively shaped by who you are, what you need, and where you are in your journey right now. No business is the same. No founder starts from the same place. That's why this isn't a template. It's a blank canvas, ready to be tailored specifically to you. Your needs define what this becomes. Your journey shapes what happens next. Let's build something that actually fits you.",
  
  "Welcome, {name}! Let me tell you why you're going to love this. Success isn't about following a rigid blueprint—it's about building something that fits your unique situation. Your business is different. Your journey is yours alone. And where you are right now matters more than anything. That's why iLaunching is a blank canvas. The entire platform adapts to you. Your individual needs. Your specific stage. Your actual goals. We meet you where you are and tailor everything around that. Let's create your path forward.",
  
  "{name}, welcome to iLaunching! Here's the core principle: success is personal. It's not static or passive—it's actively based on your individuality, your needs, and your journey. Every founder is different. Every business is at a unique point. That's why we don't use cookie-cutter solutions here. This platform is a blank canvas, designed to be shaped entirely by you. Your needs drive what you see. Your goals determine what happens next. We build around you, not the other way around. Let's make this work for you.",
  
  "Welcome, {name}! You're about to see why iLaunching is different. Success isn't one-size-fits-all. It's not passive. It's active, personal, and completely tied to your unique journey. Where you are right now, what you actually need—that's what matters. No two businesses are the same. No two founders should be forced into the same system. That's why this is a blank canvas. It transforms based on you. Your individual needs. Your specific situation. Your real goals. Let's build something tailored to you.",
  
  "{name}, you're here! Welcome to iLaunching. Here's what makes this special: we believe success is personal. It's not static. It's not passive. It's actively shaped by who you are, where you are, and what you need right now. Every business is unique. Every founder is at a different stage. That's why we built this as a blank canvas. The platform adapts to your individual needs, not the other way around. You shape what this becomes. You define your path. Let's create something that fits you perfectly.",
  
  "Hey {name}! Welcome to iLaunching. Here's the reality: success is deeply personal. It's not about following someone else's exact steps. It's about building something that fits your unique situation, your goals, and where you are in your journey right now. No business is the same. No founder should be treated like they are. That's why this platform is a blank canvas, ready to be tailored specifically to you. Your needs shape everything. Your journey defines what happens next. Let's build your success story.",
  
  "Welcome, {name}! You're in for something different. Success isn't passive—it's not about fitting into a template. It's active, personal, and based entirely on your unique journey. Every founder has different needs. Every business is at a different point. That's why iLaunching is built as a blank canvas. It transforms based on you. Your individual needs. Your specific goals. Your actual stage. We meet you where you are and build around that. Let's make this about you.",
  
  "{name}, welcome to iLaunching! Here's what you're about to experience: a platform that treats you like the individual you are. Success is personal. It's not static. It's not passive. It's actively based on your unique needs and where you are in your journey right now. No two businesses are the same. No two founders should follow the same exact path. That's why this is a blank canvas. It adapts to you. Your needs shape what you see. Your goals drive what happens next. Let's build something uniquely yours."
] as const;
